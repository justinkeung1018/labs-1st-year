...
public class StreamAlgorithms {
  ...
  public static Stream<Rectangle> translate(Stream<Rectangle> rectangles, Point vector) {
    return rectangles.map(rectangle -> new Rectangle(rectangle.getTopLeft().add(vector),
        rectangle.getBottomRight().add(vector)));
  }
  ...
  public static Stream<Rectangle> scale(Stream<Rectangle> rectangles, int factor) {
    return rectangles.map(rectangle -> rectangle.setWidth(rectangle.getWidth() * factor)
        .setHeight(rectangle.getHeight() * factor));
  }
